...
function SiteFooter({}: Props) {
  return (
    <footer className="footer footer-center p-10 bg-foreground text-background/100 dark:text- mx-auto w-full text-center">
      <div>
        <svg
          width="50"
          height="50"
          // viewBox="0 0 24 24"
          viewBox="0 0 107.78 71.1"
        ...
        <p className="font-bold">
          Nam Au Company Ltd. <br />
          Reliable Stainless Steel Supplier since 2009
        </p>
